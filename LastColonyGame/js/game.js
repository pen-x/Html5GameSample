...
var game = {
    ...
    offsetX: 0, // X & Y panning offests for the map
    offsetY: 0,
    ...
    add: function(itemDetails) {
        ...
        // Ddd the item to the type specific array
    ...
    remove: function(item) {
        ...
        for (var i = game.item.length - 1; i >= 0; i--) {
        ...
        // Remove item from the type specific array
